...
export const CHILD_ART_SEARCH = 'CHILD_ART_SEARCH';
export const CLEAR_ART = 'CLEAR_ART';
export const CLEAR_CHILD_ART = 'CLEAR_CHILD_ART';
...
export const START_CONVERSATION_LOADER = 'START_CONVERSATION_LOADER';
export const STOP_CONVERSATION_LOADER = 'STOP_CONVERSATION_LOADER';
export const START_MESSAGE_LOADER = 'START_MESSAGE_LOADER';
export const STOP_MESSAGE_LOADER = 'STOP_MESSAGE_LOADER';
export const DELETE_MESSAGE = 'DELETE_MESSAGE';
export const DELETE_CONVERSATION = 'DELETE_CONVERSATION';
export const UNREAD_CONVERSATIONS = 'UNREAD_CONVERSATIONS';
export const UPDATE_UNREAD_CONVERSATIONS = 'UPDATE_UNREAD_CONVERSATIONS';
export const CLEAR_UNREAD_CONVERSATIONS = 'CLEAR_UNREAD_CONVERSATIONS';

//Notifications
export const UPDATE_UNREAD_NOTIFICATION_COUNT = 'UPDATE_UNREAD_NOTIFICATION_COUNT';
export const RESET_UNREAD_NOTIFICATION_COUNT = 'RESET_UNREAD_NOTIFICATION_COUNT';
...
export const READ_NOTIFICATION = 'READ_NOTIIFICATION';
export const UNREAD_NOTIFICATION = 'UNREAD_NOTIFICATION';
export const STOP_NOTIFICATION_LOADERS = 'STOP_NOTIFICATION_LOADERS';
export const START_NOTIFICATION_LOADERS = 'START_NOTIFICATION_LOADERS';
